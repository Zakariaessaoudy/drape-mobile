...
import 'package:flutter/foundation.dart'; // Import crucial pour kIsWeb
...
class ImageConfirmScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // MODIFICATION : Utilisation de .value pour lier le controller existant sans rien supprimer
    return ChangeNotifierProvider<AddCameraItemController>.value(
      value: context.read<AddCameraItemController>(),
          ...
          child: ListView(
            ...
            children: [
              ...
              ClipRRect(
                ...
                child: AspectRatio(
                  aspectRatio: 3 / 4,
                  // CORRECTION DU CRASH WEB :
                  // Si on est sur Chrome (kIsWeb), on charge l'image via Image.network (Blob/URL de prévisualisation web)
                  // Sinon sur Mobile, on utilise Image.file normalement.
                  child: kIsWeb
                      ? Image.network(
                    widget.imagePath,
                    fit: BoxFit.cover,
